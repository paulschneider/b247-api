...
-- -----------------------------------------------------
-- Table `b247-com`.`display_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`display_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `b247-com`.`sponsor` (
  ...
  INDEX `sponsor -> display_type_idx` (`display_type` ASC),
  CONSTRAINT `sponsor -> image`
    FOREIGN KEY (`image_id`)
    REFERENCES `b247-com`.`asset` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `sponsor -> display_type`
    FOREIGN KEY (`display_type`)
    REFERENCES `b247-com`.`display_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `b247-com`.`article` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `article_type_id` INT NOT NULL DEFAULT 1,
  `sponsor_id` INT NULL,
  `event_id` INT NULL,
  `author_id` INT NULL,
  `display_type` INT NULL,
  ...
  `is_picked` TINYINT NULL DEFAULT 0,
  `is_promo` TINYINT NULL DEFAULT 0,
  `is_deleted` TINYINT NULL,
  ...
  INDEX `article -> type_idx` (`article_type_id` ASC),
  INDEX `article -> display_type_idx` (`display_type` ASC),
  ...
  CONSTRAINT `article -> type`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `article -> display_type`
    FOREIGN KEY (`display_type`)
    REFERENCES `b247-com`.`display_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
