...
CREATE TABLE IF NOT EXISTS `b247-com`.`article` (
  ...
  INDEX `article -> type_idx` (`display_type` ASC),
...
CREATE TABLE IF NOT EXISTS `b247-com`.`channel` (
  ...
  `updated_at` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `display_type -> type_idx` (`display_type` ASC),
  CONSTRAINT `channel_display_type -> type`
    FOREIGN KEY (`display_type`)
    REFERENCES `b247-com`.`display_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `b247-com`.`display_style`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`display_style` (
  `id` INT NOT NULL AUTO_INCREMENT,
