...
-- -----------------------------------------------------
-- Table `b247-com`.`image_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`image_type` (
  `id` TINYINT NOT NULL AUTO_INCREMENT,
  `type` TINYINT NOT NULL COMMENT '1 - hero image' /* comment truncated */ /*2 - top slider
3 - gallery*/,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `b247-com`.`asset` (
  ...
  PRIMARY KEY (`id`),
  INDEX `asset -> image_type` (`image_type` ASC),
  CONSTRAINT `image_type -> type`
    FOREIGN KEY (`image_type`)
    REFERENCES `b247-com`.`image_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `b247-com`.`article` (
  ...
  INDEX `article->venue_idx` (`venue_id` ASC),
...
-- -----------------------------------------------------
-- Table `b247-com`.`user_inactive_channel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`user_inactive_channel` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `b247-com`.`user_inactive_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`user_inactive_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `sub_channel_id` INT NOT NULL,
  `category_id` INT NOT NULL,
  ...
  INDEX `cat -> sc_idx` (`sub_channel_id` ASC),
...
-- -----------------------------------------------------
-- Table `b247-com`.`video_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`video_type` (
  `id` TINYINT NOT NULL AUTO_INCREMENT,
  `video_host` VARCHAR(255) NOT NULL COMMENT 'A host reference' /* comment truncated */ /*- YouTube
- Vimeo
*/,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
...
-- -----------------------------------------------------
-- Table `b247-com`.`video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`video` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `content` TEXT NOT NULL,
  `embed_host` TINYINT NULL,
  `author` TINYINT NULL,
  `created_at` DATETIME NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `video -> video_type` (`embed_host` ASC),
  CONSTRAINT `video -> video_type_id`
    FOREIGN KEY (`embed_host`)
    REFERENCES `b247-com`.`video_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `b247-com`.`article_video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `b247-com`.`article_video` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `article_id` INT NOT NULL,
  `video_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `video -> article_id` (`article_id` ASC),
  INDEX `video -> video_asset` (`video_id` ASC),
  CONSTRAINT `article_video->video_id`
    FOREIGN KEY (`video_id`)
    REFERENCES `b247-com`.`video` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `article_video->article_id`
    FOREIGN KEY (`article_id`)
    REFERENCES `b247-com`.`article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
